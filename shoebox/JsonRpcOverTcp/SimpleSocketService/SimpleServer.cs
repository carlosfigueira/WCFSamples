...
namespace SimpleSocketService
{
    public class SimpleServer
    {
        ...
        public SimpleServer(int port, object serviceImplementation)
        {
            ...
            this.port = port;
            this.dispatcher = new Dispatcher(serviceImplementation);
        }
        ...
        void OnReceive(IAsyncResult asyncResult)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        int length = Util.BytesToSize(state.Buffer, state.Offset);
